...
### Added
*   Indexed all 189 local Netzwerk neu A2 MP3s with unique SHA-256 identities and measured MPEG technical metadata; added a rights-safe official structure index and the exact 22-row Kapitel 2 implementation fixture. All audio page/exercise mappings remain null, publisher payloads remain excluded, and no runtime, learner, or SRS data changed.
